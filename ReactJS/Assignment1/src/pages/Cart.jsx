...
export default function Cart() {
  ...
  {cartItems.length === 0 ? (
    <p className="text-white text-lg text-center mt-10">Your cart is empty.</p>
  ) : (
  ...
  <div className="bg-gradient-to-r from-purple-800 to-indigo-800 p-6 rounded-2xl text-white shadow-2xl w-full lg:w-[400px] self-start">
    ...
    <h4 className="text-lg sm:text-xl mb-2 font-semibold text-gray-200">Your Products</h4>
    ...
    <div className="text-sm sm:text-base space-y-2">
      <p>
        🛍️ <span className="font-semibold">Total Items:</span> {totalItem}
      </p>
      <p>
